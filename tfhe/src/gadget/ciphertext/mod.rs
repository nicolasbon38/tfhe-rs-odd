...
//     ArithmeticEncrypted(LweCiphertextOwned<u32>, Encoding),
//     Trivial(bool),
// }

#[derive(Clone, Debug)]
pub enum Ciphertext{
    EncodingEncrypted(LweCiphertextOwned<u32>, Encoding),
    Trivial(bool),
}
...
impl Encoding{
    ...
    pub fn is_partition_containing(&self, element_of_zo : u32, value : u32) -> bool {
...
impl Encoding{
    ...
    pub fn new_canonical_binary(value_for_singleton_true : ZpElem, modulus_p : u32) -> Self{
